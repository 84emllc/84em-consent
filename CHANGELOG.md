...
## [1.3.1] - 2025-11-16
### Fixed
- **Page Scroll Issue** - Fixed unwanted page scroll on first visit when consent banner appears (`assets/consent.js:63`)
  - Added `preventScroll: true` option to focus() call to prevent automatic scrolling to banner
  - Maintains keyboard accessibility while keeping user at top of page
